...
const Blouses = () => {
    ...
    useEffect(() => {
        const fetchBlouses = async () => {
            setLoading(true);
            try {
                const res = await fetch(`${API}/public/products.php?category=Blouses&per_page=100`);
    ...
    const sorted = useMemo(() => {
        ...
        products.filter(p => p.category === "Blouses").forEach(sp => {
    ...
    return (
        <div>
            <PageHeroBanner
                ...
                description="Discover our premium collection of hand-embroidered, designer blouses to perfectly perfectly complement your elegant sarees."
            ...
            <div className="container mx-auto px-4 lg:px-8 py-10 lg:py-16">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-32 text-center gap-6">
                        ...
                        <p className="font-display text-lg italic text-[#0D3B2E]/60">Curating the finest blouses...</p>
                    </div>
                ) : sorted.length === 0 ? (
